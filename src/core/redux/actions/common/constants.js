...
/** @constant {string} TOGGLE_SIDEBAR */
export const TOGGLE_SIDEBAR = 'core/redux/common/TOGGLE_SIDEBAR';
...
/** @constant {string} SET_OPINIONES */
export const SET_OPINIONES = 'core/redux/common/SET_OPINIONES';
